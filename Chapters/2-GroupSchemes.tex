...
\begin{rem}[Short exact sequence]
	...
	morphism on $G/H$, making it an $S$-group scheme, and $u\colon G \to G/H$
	...
	seen in tk: add reference + add example.
\end{rem}
...
\subsection{Separable algebras and étale group schemes}
