...
\begin{rem}[Kernels and cokernels]
	...
	tk: add comment from Brinon here, plus write down your observations on kernels.
...
tk: maybe state here that we will concentrate on $S = \mathrm{Spec}(R)$?
...
\begin{thm}[{\cite[\S 3.7]{Waterhouse}}, Cartier duality]
...
\begin{prop}[]
	Let $G$ be a finite $R$-group scheme.
	The following are equivalent:
\begin{enumerate}
	\item $G$ is étale,
	\item $\ker F_G = 1$,
