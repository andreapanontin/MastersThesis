...
\begin{rem}[]\label{rem:j_iTheoremA6}%tk:fixitttt
...
Then, given a $p$-divisible group $G_i \in \mathsf{BT}/O_K/(\pi^i)$,
...
\item We now iteratively lift this construction.
	...
	there is a unique $G_i \in \mathsf{BT}/O_K/(\pi^i)$
...
\noindent
Now that we have proved this theorem let's explicit some important examples.
