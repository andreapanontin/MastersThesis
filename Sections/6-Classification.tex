...
generalize the classification of Barsotti-Tate groups over a field
...
with uniformizer $\pi$ of $K$ whose (Eisenstein) minimal polynomial is
$E(u) \in K_0[u]$.
...
\begin{rem}[]\label{rem:A2Kisin}
	Even though we will not prove the theorem, we feel it is important to write
