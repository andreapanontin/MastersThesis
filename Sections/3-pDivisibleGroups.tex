...
\begin{rem}[]
	More details about the construction carried out
	in \cref{ex:ConnectedpDivGroupFLG} can be found at \cite[\S6]{Shatz}.
\end{rem}
...
\begin{lem}[{\cite[Chapter 2, \S4, lemma 4.13]{Messing}}]\label{lem:BT/admissible}
