...
\begin{ntt}[]
	...
	on which $G_K$ acts multiplicatively by $\chi$.
	More explicitly the action of $G_K$ on $\mathbb{Z}_{p}(1)$ is given by
	\begin{equation*}
		g \cdot x \coloneqq \chi(g) x
	\end{equation*}
	for all $x \in \mathbb{Z}_{p}(1)$ and all $g \in G_K$.
	...
	\left( \mathbb{Z}_{p}(1), \mathbb{Z}_{p} \right)$ and $g \in G_K$, by
	\begin{equation*}
		(g \cdot f)(x) \coloneqq f (g^{-1} x)
	,\end{equation*}
	since the action of $G_K$ on $\mathbb{Z}_{p}$ is trivial.
	...
	with $\mathbb{Z}_{p}$, but the action of $G_K$ has been twisted by
	...
	It is given, for all $m \in M$ and all $g \in G_K$, by
	\begin{equation*}
...
\begin{proof}
	...
	\begin{align*}
		...
		\left( \left( G_v \right))_{\overline{K}}, \left( \mathbb{G}_m \right)_{\overline{K}} \right) \\
		&\stackrel{2}{\simeq} \varprojlim_{v \in \mathbb{N}}
		\mathcal{H}\mathrm{om}_{ \mathsf{Gp}_{\overline{K}} }
		\left( \left( G_v\right))_{\overline{K}},\left( \mathbb{G}_m(p)\right)_{\overline{K}}\right)
		\simeq \mathcal{H}\mathrm{om}_{ \mathsf{Gp}_{\overline{K}} }
		\left( \left( G \right)_{\overline{K}}, \left( \mathbb{G}_m(p) \right)_{\overline{K}} \right)\\
		&\stackrel{3}{\simeq} \mathrm{Hom}_{ \mathsf{Gp} } 
		\left( G(\overline{K}), (\mathbb{G}_m(p))_{\overline{K}}(\overline{K}) \right)
	...
	Isomorphism $3$ holds by (tk: I didn't manage to give a compelling argument for this).
	For isomorphism $4$ notice that $(\mathbb{G}_m)_{\overline{K}}(\overline{K})$ consists of all
	$p^n$-th roots of unity in $\overline{K}$, on which $G_K$ acts via the cyclotomic character.
	As a ring this is isomorphic to $\mathbb{Z}_{p}$ (viewed in multiplicative notation),
	on which the action of $G_K$ is trivial, being contained in $K$.
	Then it is clear that $\mu_{p^\infty}(\overline{K}) \simeq \mathbb{Z}_{p}(1)$.
	Finally isomorphism $5$ holds, since the action of $G_K$ on 
	$\mathrm{Hom}_{ \mathsf{Gp} } \left( G(\overline{K}), \mathbb{Z}_{p} \right)$
	is given by $(g \cdot f)(x) = gf(g^{-1}x)$ for all $g \in G_K, 
