...
which in turn bases itself on \cite[Chapter I, \S10]{EGA1}.
...
Let's notice that this construction follows that of \cite[Chapter I, \S10]{EGA1},
...
\begin{rem}[]
	...
	Again we will leave them to \cite[Chapter I, \S10]{EGA1}.
\end{rem}
...
\begin{rem}[]
	...
	In fact, as can be seen in \cite[Chapter I, \S10.6]{EGA1}, one can do a similar construction
	with formal schemes.
...
%tk: do I keep this remark? For the moment I decided to skip this lemma.
...
%\begin{lem}[{\cite[Chapter II, \S1, lemma 1.1.6]{Messing}}]
...
\begin{rem}[Comparison of the two points of view]
	...
	As a consequence we obtain that the following is exact:
	\begin{equation*}
	\begin{tikzcd}
		0 \arrow[r, "", rightarrow] &
		G_v \arrow[r, "i_v", rightarrow] &
