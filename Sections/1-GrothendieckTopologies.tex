...
\begin{prop}[{\cite[\S 2.3.2]{Vistoli}}]\label{Conditionsfpqc}
...
\begin{defn}[fpqc morphism]
	...
	that satisfies the equivalent conditions of \cref{Conditionsfpqc}.
...
\begin{thm}[{\cite[\S 2.3.6]{Vistoli}}, Grothendieck]\label{reprFctSheaf}
