...
\begin{prop}[{\cite[\href{https://stacks.math.columbia.edu/tag/00WH}{Proposition 00WH}]{SP}}]
...
\begin{rem}[{\cite[\href{https://stacks.math.columbia.edu/tag/00VE}{Lemma 00VE}]{SP}}]
...
\begin{defn}[Continuous functors]
...
\begin{lem}[{\cite[\href{https://stacks.math.columbia.edu/tag/00WW}{Lemma 00WW}]{SP}}]
...
\begin{rem}[{\cite[\href{https://stacks.math.columbia.edu/tag/00WX}{Lemma 00WX}]{SP}}]
	Given $\mathsf{C}, \mathsf{D}$ and $u$ as before,
	$u_s$ is left adjoint to $u^s$.
\end{rem}


\begin{defn}[Morphism of sites]
	Let $\mathsf{C}$ and $\mathsf{D}$ be sites.
...
\begin{ex}[{\cite[\href{https://stacks.math.columbia.edu/tag/00X2}{Example 00X2}]{SP}}]
