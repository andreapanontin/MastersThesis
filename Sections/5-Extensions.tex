...
\begin{proof}
	...
	as seen in \cref{rem:rigidityExt}.
	...
	\cref{rem:rigidityExt}, any extension $\xi$ of $G$ by a
...
\begin{rem}[{\cite[Chapter IV, \S2.5]{Messing}}]
	...
	Moreover, given a morphism in $\mathsf{Crys}(S_0)$,
...
\begin{rem}[{\cite[Chapter IV, \S2.5]{Messing}}]
	...
	(tk: I think this could be a correct interpretation of the concept,
	though I haven't checked it thoroughly).
\end{rem}
